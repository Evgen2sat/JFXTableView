...
public class ConvertToValidBigDecimalFilterCommand implements ConvertToValidFilterCommand {

    private String originalText;

    public ConvertToValidBigDecimalFilterCommand(String originalText) {
