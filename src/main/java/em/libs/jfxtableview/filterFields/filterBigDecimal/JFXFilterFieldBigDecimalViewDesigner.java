...
public abstract class JFXFilterFieldBigDecimalViewDesigner extends JFXFilterFieldView {
    ...
    public JFXFilterFieldBigDecimalViewDesigner(List<FilterTypeModel> filterTypes) {
    ...
    protected final void applyChangeFilterType(String icon, String tooltipText, FilterTypeEnum filterType, FilterModeEnum filterMode, List<FilterModel> filterValues) {
        ...
        if (txtSearchField.getText() != null && !txtSearchField.getText().isEmpty()) {
            filterValue = new BigDecimal(txtSearchField.getText());
        }
    ...
    protected abstract void setFilterType(BigDecimal value, FilterTypeEnum type, FilterModeEnum filterMode, List<FilterModel> filterValues);
