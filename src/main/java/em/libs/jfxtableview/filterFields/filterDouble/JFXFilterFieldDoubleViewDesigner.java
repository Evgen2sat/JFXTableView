...
public abstract class JFXFilterFieldDoubleViewDesigner extends JFXFilterFieldView {
    ...
    public JFXFilterFieldDoubleViewDesigner(List<FilterTypeModel> filterTypes) {
    ...
    protected final void applyChangeFilterType(String icon, String tooltipText, FilterTypeEnum filterType, FilterModeEnum filterMode, List<FilterModel> filterValues) {
        ...
        if (txtSearchField.getText() != null && !txtSearchField.getText().isEmpty()) {
            filterValue = Double.valueOf(txtSearchField.getText());
        }
    ...
    protected abstract void setFilterType(Double value, FilterTypeEnum type, FilterModeEnum filterMode, List<FilterModel> filterValues);
