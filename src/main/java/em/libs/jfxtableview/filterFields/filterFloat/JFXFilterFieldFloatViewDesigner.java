...
public abstract class JFXFilterFieldFloatViewDesigner extends JFXFilterFieldView {
    ...
    public JFXFilterFieldFloatViewDesigner(List<FilterTypeModel> filterTypes) {
    ...
    protected final void applyChangeFilterType(String icon, String tooltipText, FilterTypeEnum filterType, FilterModeEnum filterMode, List<FilterModel> filterValues) {
        ...
        if (txtSearchField.getText() != null && !txtSearchField.getText().isEmpty()) {
            filterValue = Float.valueOf(txtSearchField.getText());
        }
    ...
    protected abstract void setFilterType(Float value, FilterTypeEnum type, FilterModeEnum filterMode, List<FilterModel> filterValues);
