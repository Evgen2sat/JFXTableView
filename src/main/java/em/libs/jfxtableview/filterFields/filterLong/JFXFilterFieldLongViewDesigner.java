...
public abstract class JFXFilterFieldLongViewDesigner extends JFXFilterFieldView {
    ...
    public JFXFilterFieldLongViewDesigner(List<FilterTypeModel> filterTypes) {
    ...
    protected final void applyChangeFilterType(String icon, String tooltipText, FilterTypeEnum filterType, FilterModeEnum filterMode, List<FilterModel> filterValues) {
        ...
        if(txtSearchField.getText() != null && !txtSearchField.getText().isEmpty()) {
            filterValue = Long.valueOf(txtSearchField.getText());
        }
    ...
    protected abstract void setFilterType(Long value, FilterTypeEnum type, FilterModeEnum filterMode, List<FilterModel> filterValues);
