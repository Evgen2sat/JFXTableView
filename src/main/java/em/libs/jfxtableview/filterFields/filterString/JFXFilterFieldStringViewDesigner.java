...
public abstract class JFXFilterFieldStringViewDesigner extends JFXFilterFieldView {
    ...
    public JFXFilterFieldStringViewDesigner(List<FilterTypeModel> filterTypes) {
    ...
    protected final void applyChangeFilterType(String icon, String tooltipText, FilterTypeEnum filterType, FilterModeEnum filterMode, List<FilterModel> filterValues) {
        ...
        setFilterType(txtSearchField.getText(), filterType, filterMode, filterValues);
        popupChangeFilterType.hide();
    }
    ...
    protected abstract void setFilterType(String text, FilterTypeEnum type, FilterModeEnum filterMode, List<FilterModel> filterValues);
